<style>
    ...
    <div class="header">FOCUS GROUP COMMENTS</div>

    <table>
        <tr>
            <td>
                <strong>Students in the Computer Science Program commented on their experience in the program, as follows:</strong>
                <br><br>

                <strong>Student Remark – Beirut Campus:</strong>
                <ol>
                    <li>One student suggested combining CSC310 lab to the course and counting it as a 4 credit course.</li>
                    <li>One student stressed the right to choose course and instructor during registration.</li>
                    <li>Some students feel they are not meeting regularly with their advisor.</li>
                    <li>Students requested more developmental courses such as Web and Mobile.</li>
                    <li>Concern about excessive theory and paper-based coding exams.</li>
                    <li>Request for more hands-on project-based assessments.</li>
                    <li>Suggestion to reduce LAC courses and increase technical electives.</li>
                    <li>Concern that CSC380 is too theoretical.</li>
                    <li>Questions about the number of required Math courses.</li>
                    <li>Request for more applied Machine Learning content.</li>
                </ol>
            </td>
        </tr>
    </table>
    ...
    <div class="header">ADVISORY COUNCIL COMMENTS</div>

    <table>
        <tr>
            <td style="height:60px;">
                <!-- Leave empty or populate later -->
            </td>
        </tr>
    </table>
    ...
    <div class="header">EXIT SURVEY RESULTS</div>
    ...
    <div class="header">STAKEHOLDER SURVEY RESULTS</div>
    ...
    <div class="header">SUGGESTED PLAN OF ACTION WITH IMPLEMENTATION SCHEDULE</div>

    <table>
        <tr>
            <td style="width:30%;"><strong>Implementation Period</strong></td>
    ...
    <div class="header">EXPLAIN WHETHER THE PROPOSED ACTIONS ARE MAJOR OR MINOR</div>

    <table>
        <tr>
            <td style="width:30%;"><strong>Period</strong></td>
            <td>Fall 2025 – Spring 2026</td>
        </tr>
        <tr>
            <td colspan="2" style="height:80px;">
    ...
    <div class="header">SUGGESTED REVIEW PROCESS</div>
