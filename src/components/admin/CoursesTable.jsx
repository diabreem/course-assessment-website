...
const CoursesTable = () => {
    ...
    const handleUpdate = async () => {
        ...
        setCourses((prev) =>
            prev.map((c) => (c.id === selectedId ? res.data : c))
        );
        setOpenEdit(false);
    ...
    return (
        <Box sx={{ width: "100%" }}>
            ...
            >
                <DialogTitle className="text-(--primary-color)">Edit Course</DialogTitle>
                <DialogContent className="flex flex-col gap-3">
                    <div className="flex justify-between">
                        <div className="flex flex-col">
                            ...
                            <label>
                                Course Code:  </label>
                            <input type="text" placeholder="eg. CSC XXX"
                        ...
                        <div className="flex flex-col">
                            ...
                            <input type="text"
                                ...
                                onChange={(e) =>
                                    setCourseData({ ...courseData, course_title: e.target.value })
                                } className="border border-gray-400 rounded p-1 w-64"
                            />
                ...
                <DialogActions>
                    ...
                    >Cancel</button>
                    <button onClick={handleUpdate} className="bg-(--primary-color) text-white p-1 rounded w-16 cursor-pointer"
                    >Update</button>
                </DialogActions>
            </Dialog>
            ...
            >
                ...
                <DialogActions>
                    ...
                    >Cancel</button>
                    <button onClick={handleAdd} className="bg-(--primary-color) text-white p-1 rounded w-16 cursor-pointer"
                    >Add</button>
                </DialogActions>
            </Dialog>
